...
%>
<div class="navbar" style="background-color: #c03ae2; overflow: hidden;">
			  ...
			  <div class="col-sm-4">
			    <div class="card">
			      <div class="card-body">
			        ...
			        <button name="type" value="small" class="btn btn-primary" style="background-color: #c03ae2;">Top 5 Stocks</button>
			        </div>
			      </div>
			    </div>
			  </div>
			  <div class="col-sm-4">
			    <div class="card">
			      <div class="card-body">
			        ...
			        <div class="col-md-12 text-center">
			        <button name="type" value="mid" class="btn btn-primary" style="background-color: #c03ae2;">Top 5 Stocks</button></div>
			      </div>
			    </div>
			  </div>
			  <div class="col-sm-4">
			    <div class="card">
			      <div class="card-body">
			        ...
			        <div class="col-md-12 text-center">
			        <button name="type" value="large" class="btn btn-primary" style="background-color: #c03ae2;">Top 5 Stocks</button></div>
			      </div>
			    </div>
			  </div>
	</div>
